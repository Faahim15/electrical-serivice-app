...
import { useCreateLightingMutation } from "@/src/redux/api-slices/quote/lighting-api";
...
const LightingReviewForm = ({
  ...
  const [createLighting] = useCreateLightingMutation();
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await createLighting(
