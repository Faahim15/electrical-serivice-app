...
import { useCreateElectricMutation } from "@/src/redux/api-slices/quote/electricApi";
...
const ElectricalInspectionReviewForm = ({
  ...
  const [createElectric] = useCreateElectricMutation();
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await createElectric(
