...
import { useCreateNewConstructionMutation } from "@/src/redux/api-slices/quote/newConstructionApi";
...
const NewConstructionReviewForm = ({
  ...
  const [createNewConstruction] = useCreateNewConstructionMutation();
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await createNewConstruction(
