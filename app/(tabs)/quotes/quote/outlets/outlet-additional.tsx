...
export default function OutletAdditional() {
  ...
  useEffect(() => {
    ...
    if (draft.additionalInformation) {
      ...
      dispatch(
        updateOutletsDetails({ additionalNotes: draft.additionalInformation }),
      );
    }
  }, [draft]);
  ...
  const handleNotesChange = (text: string) => {
    ...
    dispatch(updateOutletsDetails({ additionalNotes: text }));
  };
  ...
  const handleContinue = () => {
    if (localAdditionalNotes) {
      dispatch(updateOutletsDetails({ additionalNotes: localAdditionalNotes }));
    }
    router.push({
